       ...
       // cout<<T<<" "<<V<<" "<<E<<endl;
        ...
        for(int t=0; t<tfinal; t++)
        {
            ...
            if (tsamp>0)
            {
                ...
                //Checking for errors in calculating the RMS-distance
            ...
            // Checking if the sampling technique gives the correct answer, this part is computationally heavy, and has thus been commented out
